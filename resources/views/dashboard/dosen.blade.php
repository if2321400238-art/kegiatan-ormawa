            ...
            <div class="table-card flex-1">
                <div class="p-4 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-[12px] text-gray-400">Pengajuan kegiatan Ormawa binaan yang perlu ditinjau</p>
                    </div>
                    <a href="{{ route('dosen.verifikasi.index') }}" class="badge badge-warning hover:bg-warning-light/80">Lihat Semua</a>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dosen.verifikasi.show', $pengajuan) }}" class="badge badge-info hover:underline text-xs">Persetujuan</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm flex-1 flex flex-col min-h-0 overflow-hidden">
                <div class="p-4 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-[12px] text-gray-400">Panduan persetujuan Dosen Pembina</p>
                    </div>
                </div>
