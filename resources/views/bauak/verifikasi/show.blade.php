<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('bauak.verifikasi.index') }}" class="text-blue-600 hover:text-blue-800">
                ← Kembali
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    {{-- Detail Pengajuan (sama seperti show.blade.php tapi tanpa timeline) --}}
                ...
                {{-- Sidebar - Form Verifikasi --}}
                <div class="space-y-6">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-4">Verifikasi</h3>

                            <form action="{{ route('bauak.verifikasi.verify', $pengajuan) }}" method="POST">
                                @csrf
