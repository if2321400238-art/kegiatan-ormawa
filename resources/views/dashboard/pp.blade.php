<x-app-layout>
    <x-slot name="title">Dashboard PP (Kepala/Wakil PP)</x-slot>
        ...
        <div class="lg:col-span-2">
            <div class="card">
                <div class="card-header border-b">
                    <h5 class="card-title">📋 Pengajuan Terbaru (Monitoring)</h5>
                </div>
                            ...
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-24 bg-gray-200 rounded-full h-2">
                                        <div class="bg-purple-500 h-2 rounded-full" style="width: {{ min(($stat['pengajuan'] / 10) * 100, 100) }}%"></div>
                                    </div>
