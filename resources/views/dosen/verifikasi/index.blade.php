        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-wrap gap-4">
                <a href="?tab=menunggu" class="pb-2 border-b-2 {{ request('tab', 'menunggu') == 'menunggu' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} text-xs sm:text-sm font-medium">
                    Menunggu Verifikasi ({{ $pengajuanMenunggu->total() }})
                </a>
            ...
            @if(request('tab', 'menunggu') == 'menunggu')
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 sm:p-6">
                        <h3 class="text-base sm:text-lg font-semibold mb-4">Pengajuan Menunggu Verifikasi</h3>
                                        ...
                                        @foreach($pengajuanMenunggu as $index => $item)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a href="{{ route('dosen.verifikasi.show', $item) }}" class="text-blue-600 hover:text-blue-900">
                                                        Verifikasi →
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="md:hidden space-y-3">
                                @foreach($pengajuanMenunggu as $item)
                                    <div class="border rounded-lg p-3">
                                        ...
                                        <a href="{{ route('dosen.verifikasi.show', $item) }}" class="text-center w-full text-sm bg-blue-100 text-blue-600 rounded px-3 py-2 hover:bg-blue-200">
                                            Verifikasi →
                                        </a>
                                    </div>
                                @endforeach
                        ...
                        @else
                            <div class="text-center py-8 sm:py-12">
                                ...
                                <p class="mt-4 text-gray-500 text-sm">Tidak ada pengajuan yang menunggu verifikasi</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            @else
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 sm:p-6">
                        <h3 class="text-base sm:text-lg font-semibold mb-4">Riwayat Verifikasi Saya</h3>
                                        ...
                                        <div class="flex flex-col sm:flex-row justify-between sm:items-start gap-3">
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="mt-2 flex flex-wrap items-center gap-2">
                                                    ...
                                                    <span class="text-xs text-gray-500">{{ $verifikasi->tanggal_verifikasi->format('d M Y H:i') }}</span>
                                                </div>
                                            ...
                                            <a href="{{ route('dosen.verifikasi.show', $verifikasi->pengajuanKegiatan) }}" class="w-full sm:w-auto text-center text-xs sm:text-sm text-blue-600 hover:text-blue-800 px-3 py-2 bg-blue-100 rounded hover:bg-blue-200">
                                                Lihat →
                                            </a>
                                        </div>
                                    </div>
                        ...
                        @else
                            <p class="text-center text-gray-500 py-6 sm:py-8 text-sm">Belum ada riwayat verifikasi</p>
                        @endif
                    </div>
                </div>
            @endif
