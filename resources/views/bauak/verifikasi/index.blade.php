                                        ...
                                        @foreach($pengajuanMenunggu as $index => $item)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a href="{{ route('bauak.verifikasi.show', $item) }}" class="text-blue-600 hover:text-blue-900">
                                                        Verifikasi →
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="md:hidden space-y-3">
                                @foreach($pengajuanMenunggu as $item)
                                    <div class="border rounded-lg p-3">
                                        ...
                                        <a href="{{ route('bauak.verifikasi.show', $item) }}" class="text-center w-full text-sm bg-blue-100 text-blue-600 rounded px-3 py-2 hover:bg-blue-200">
                                            Verifikasi →
                                        </a>
                                    </div>
                                @endforeach
                                ...
                                @foreach($riwayatVerifikasi as $verifikasi)
                                    <div class="border rounded-lg p-3 sm:p-4 hover:bg-gray-50">
                                        <div class="flex flex-col sm:flex-row justify-between sm:items-start gap-3">
                                            ...
                                            <a href="{{ route('pengajuan.show', $verifikasi->pengajuanKegiatan) }}" class="w-full sm:w-auto text-center text-xs sm:text-sm text-blue-600 hover:text-blue-800 px-3 py-2 bg-blue-100 rounded hover:bg-blue-200">
                                                Lihat →
                                            </a>
                                        </div>
                                    </div>
